<div id="modal">
 <div class="modal-header" style="text-align:center">
    ...
    <h4 class="modal-title" id="exampleModalLabel">Modificar Area</h4>
  </div>
  <div id="modal_content">
    ...
    <form action="<?php echo base_url()?>sip/area/actualizar_area" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" autocomplete="off">
        <?php foreach ($area as $datos){
        ?>
