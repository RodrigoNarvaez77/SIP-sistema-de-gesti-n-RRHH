<body>
<body>
  <form action="<?php echo base_url() ?>sip/profesiones/verificar" role="form" id="form" method='post' autocomplete="off">
    <div class="panel panel-white"><br>
      <div class="row">
        <div class="col-md-10">
          <p align="left">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <i>En esta secci&oacute;n se pueden agregar, editar y eliminar especialidades.</i>
          </p>
        </div>
        <div class="col-md-2">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="row">
          ...
          ?>
            <tr style="text-align:center">
              ...
              <td style="width:60px;"><a data-toggle="modal" href="<?php echo base_url()?>sip/profesiones/modal_editar/<?php echo $datos->id?>" data-target="#ModalEditar"><i class="fa fa-edit"></i></a></td>
              <td style="width:53px;" aling="center"><a href="javascript:;" onclick="aviso('<?php echo base_url()?>sip/profesiones/eliminar/<?php echo $datos->id?>'); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                <?php
                  }  
                ?>
            </tr>
              ...
              <p>*Todos los campos sus obligatorios.</p>
                ...
                <div class="control-group">
                  <label class="control-label" for="inputTipo"></label>
                      <form action="<?php echo base_url() ?>sip/profesiones/guardar_profesion" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
